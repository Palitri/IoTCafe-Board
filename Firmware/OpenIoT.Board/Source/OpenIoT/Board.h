...
{
private:
	static const int pwmBitResolution;
	static const int pwmMaxValue;

	static const int analogReadBitResolution;
	static const int analogReadMaxValue;
	static const int analogReadHalfValue;
